            ...
            Row(
              ...
              children: [
                TextButton(
                  ...
                  child: Text(
                    AppText.cancel,
                    style: AppStyle.heading3.copyWith(fontWeight: FontWeight.w300, color: AppColors.primaryWhite),
                  ),
                ),
                SizedBox(
                  width: 20,
                ...
                TextButton(
                  ...
                  child: Text(
                    AppText.rename,
                    style: AppStyle.heading3.copyWith(fontWeight: FontWeight.w300, color: AppColors.mainColor.withOpacity(0.9)),
                  ),
                ),
              ],
            )
